...
func (h *BaseHandler) RequestIsJSON(r *http.Request) bool {
...
func (h *BaseHandler) MustUserId(c echo.Context) string {
	return c.Get("user_id").(string)
}

func (h *BaseHandler) MustClientId(c echo.Context) string {
	return c.Get("client_id").(string)
}

// nolint:gocyclo,cyclop
func (h *BaseHandler) StatusText(code int) string {
	switch code {
	...
	case http.StatusLocked:
		return "Доступ времмено заблокирован"
